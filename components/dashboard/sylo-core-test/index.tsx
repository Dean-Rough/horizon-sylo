...
import { HiCog6Tooth, HiCommandLine } from 'react-icons/hi2';
...
export default function SyloCoreTest() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-gray-900">Sylo-Core Testing Interface</h1>
          <p className="text-gray-600">Test and debug Sylo-Core commands and API integration</p>
        </div>
